...
import {
  ...
  Mail,
  MapPin,
  Activity,   // Added: Study Habit Analyzer
  Quote,      // Added: Citation Generator
  Book,       // Added: Reading Comprehension Trainer
  Gamepad,    // Added: Memory Game Generator
  Type,       // Added: Grammar Practice
  Coffee,     // Added: Study Break Planner
} from "lucide-react"
